...
export const RFS = {
  ...
  dcTiers: {
    standard: [
      ...
      { label: "RFS.Difficulty.Elite",     dc: 12 },
      { label: "RFS.Difficulty.Legendary", dc: 15 },
      { label: "RFS.Difficulty.Mythic",    dc: 18 },
    ],
    moreXp: [
      { label: "RFS.Difficulty.Easy",      dc: 4  },
      { label: "RFS.Difficulty.Medium",    dc: 8  },
      { label: "RFS.Difficulty.Hard",      dc: 12 },
      { label: "RFS.Difficulty.Elite",     dc: 16 },
      { label: "RFS.Difficulty.Legendary", dc: 20 },
